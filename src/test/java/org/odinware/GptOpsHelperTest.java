...
public class GptOpsHelperTest {
    ...
    @Test
    public void testBuildCustomRequest() {
        ...
        when(mockRequestBuilder.buildRequest(any(Context.class), any(JSONArray.class)))
                .thenReturn(new Request.Builder().url(validApiUrl).build());

        // Call the method under test
        Request request = GptOpsHelper.buildCustomRequest(mockRequestBuilder, mockContext, mockOdinMessages);
